...
import { showError, deleteFileFromStorage, showProgress } from '../../utils/firebase';
import UploadArea from '../../components/materialUI/UploadArea';
import ProgressBar from '../../components/materialUI/ProgressBar';

export class EditProjectImagePage extends React.Component {
    constructor(props) {
        super(props);
        this.state = {
            error: '',
        ...
        return (
            <div>
                <div className="content-container">
                    ...
                    <p>Click above area to upload the project image(The recommended minimal width of the project image should be at least 400 pixels)</p>
...
export default connect(mapStateToProps, mapDispatchToProps)(EditProjectImagePage);